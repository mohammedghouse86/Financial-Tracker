          ...
          <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              <div className="flex flex-shrink-0 items-center">
                <img src="/finance app logo.png" alt="Finance App Logo" width={32} height={32} />
              </div>
              <div className="hidden sm:ml-6 sm:block">
                <div className="flex space-x-4">
                  <div className="rounded-md bg-green-900 px-4 py-2 text-sm font-medium text-white"> FINANCE TRACKER</div>
            ...
            <button type="button" className="relative rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
              ...
              </button><div className="rounded-md bg-green-900 px-4 py-2 text-sm font-medium text-white">{session.name}</div>
